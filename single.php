				...
				<section class="author-box module-wrap" itemscope itemtype="https://schema.org/Person">
					...
					<div class="author-info">
						...
						<div class="author-links">
							...
							<div class="author-social" aria-label="<?php esc_attr_e( 'Author social links', 'tradingle' ); ?>">
								<?php if ( get_the_author_meta( 'twitter' ) ) : ?>
									<a href="<?php echo esc_url( get_the_author_meta( 'twitter' ) ); ?>" rel="noopener noreferrer" target="_blank">X</a>
								<?php endif; ?>
								<?php if ( get_the_author_meta( 'linkedin' ) ) : ?>
									<a href="<?php echo esc_url( get_the_author_meta( 'linkedin' ) ); ?>" rel="noopener noreferrer" target="_blank">in</a>
								<?php endif; ?>
								<?php if ( get_the_author_meta( 'user_url' ) ) : ?>
									<a href="<?php echo esc_url( get_the_author_meta( 'user_url' ) ); ?>" rel="noopener noreferrer" target="_blank">↗</a>
								<?php endif; ?>
							</div>
						</div>
					</div>
