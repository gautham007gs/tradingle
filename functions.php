...
function tradingle_enqueue_assets() {
	...
	$critical_css = '.utility-bar{height:36px;background:var(--color-secondary)}.site-header{position:sticky;top:0;z-index:1000;box-shadow:0 2px 8px rgba(0,0,0,.06)}.header-inner{min-height:var(--header-height);display:grid;grid-template-columns:160px minmax(0,760px) 200px}.hero-grid{display:grid;grid-template-columns:740px 1fr;gap:var(--layout-gap)}';
